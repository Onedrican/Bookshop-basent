    ...
    if (isset($_POST['delete'])) {
        ...
        if (count($results) > 0) {
            foreach ($results as $user) {
                ...
                echo '<form method="POST"><button type="submit" name="delete" value="' . $user['ID'] . '" onclick="return confirm(\'Möchten sie diesen User wirklich löschen?\')">Delete</button></form>';
                echo "</div>";
            }
        } else {
